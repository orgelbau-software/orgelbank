...
class GoogleMapsGeocoder
{
     ...
     * @param float|string $southwestLatitude
     *            southwest latitude boundary
     * @param float|string $southwestLongitude
     *            southwest longitude boundary
     * @param float|string $northeastLatitude
     *            northeast latitude boundary
     * @param float|string $northeastLongitude
     ...
     * The return type is based on the requested
     ...
     * @param float|string $longitude
     *            to draw the bounding box around
     * @param int|float|string $mileRange
