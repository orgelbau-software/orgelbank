...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @var float
    */
    private $_margin_head;

    /**
    * The margin for the footer
    * @var float
    */
    private $_margin_foot;
    ...
    * @var bool
    */
    private $_outline_style;

    /**
    * Whether to have outline summary below.
    * @var bool
    */
    private $_outline_below;

    /**
    * Whether to have outline summary at the right.
    * @var bool
    */
    private $_outline_right;

    /**
    * Outline row level.
    * @var integer
    */
    private $_outline_row_level;
