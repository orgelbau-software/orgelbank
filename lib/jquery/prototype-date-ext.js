...
( function() {
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.isLeapYear();
	 * @result true
	 * 
	 * @name isLeapYear
	 * @type Boolean
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.isWeekend();
	 * @result false
	 * 
	 * @name isWeekend
	 * @type Boolean
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.isWeekDay();
	 * @result false
	 * 
	 * @name isWeekDay
	 * @type Boolean
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getDaysInMonth();
	 * @result 31
	 * 
	 * @name getDaysInMonth
	 * @type Number
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getDayName();
	 * @result 'Saturday'
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getDayName(true);
	 * @result 'Sat'
	 * 
	 * @param abbreviated
	...
	add("getDayName", function(abbreviated) {
		return abbreviated ? Date.abbrDayNames[this.getDay()]
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getMonthName();
	 * @result 'Janurary'
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getMonthName(true);
	 * @result 'Jan'
	 * 
	 * @param abbreviated
	 *            Boolean When set to true the name will be abbreviated.
	...
	add("getMonthName", function(abbreviated) {
		return abbreviated ? Date.abbrMonthNames[this.getMonth()]
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getDayOfYear();
	 * @result 11
	 * 
	 * @name getDayOfYear
	 * @type Number
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.getWeekOfYear();
	 * @result 2
	 * 
	 * @name getWeekOfYear
	 * @type Number
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.setDayOfYear(1);
	 *          dtm.toString();
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.addYears(1);
	 *          dtm.toString();
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.addMonths(1);
	 *          dtm.toString();
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.addDays(1);
	 *          dtm.toString();
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.addHours(24);
	 *          dtm.toString();
	 * @result 'Sun Jan 13 2008 00:00:00'
	 * 
	 * @name addHours
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.addMinutes(60);
	 *          dtm.toString();
	 ...
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.addSeconds(60);
	 *          dtm.toString();
	 ...
	 * 
	 * @example var dtm = new Date(); dtm.zeroTime(); dtm.toString();
	 * @result 'Sat Jan 12 2008 00:01:00'
	 * 
	 * @name zeroTime
	 * @type Date
	 ...
	 * didn't overwrite it)
	 * 
	 * @example var dtm = new Date("01/12/2008"); dtm.asString();
	...
	add("asString", function() {
		var r = Date.format;
		return r.split('yyyy').join(this.getFullYear()).split('yy').join(
				(this.getFullYear() + '').substring(2)).split('mmm').join(
				this.getMonthName(true)).split('mm').join(
				_zeroPad(this.getMonth() + 1)).split('dd').join(
				_zeroPad(this.getDate()));
	});
	 ...
	 * elsewhere)
	 * 
	 * @example var dtm = Date.fromString("12/01/2008"); dtm.toString();
