 ...
 * --------------------
 */
// $carddav = new carddav_backend('http://localhost/sabre-dav/addressbookserver.php/addressbooks/admin/contacts/');
$carddav = new carddav_backend('http://localhost/orgelbank/src/services/addressbook/orgelbank.php');
$carddav->enable_debug();
$carddav->set_auth('foo', 'bar');
echo $carddav->get();
...
FN:Stephan De Jong
UID:8d9b17e7-9d69-4d24-a016-b67258348cbb
END:VCARD';

var_dump($carddav->query("http://localhost/sabre-dav/addressbookserver.php/addressbooks/admin/contacts/8d9b17e7-9d69-4d24-a016-b67258348cbb.vcf", 'PUT', $vcard, 'text/vcard'));
die("");
/*
 *
 *
...
class carddav_backend
{
     ...
     *
     * @return array available debug information
     */
     ...
     *            within the response (simplified only)
     * @param boolean $raw
     *            raw or simplified
     * @return string or simplified XML response
     */
     ...
     * @param string $vcard_id
     *            on the CardDAV Server
     * @return string or simplified vCard (text/xml)
     */
     ...
     *            URL
     * @param string $method
     *            like (OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, COPY, MOVE)
     * @param string $content
     *            CardDAV queries
     * @param string $content_type
     *            type
     * @return array CardDAV Response and http status code
     */
    public function query($url, $method, $content = null, $content_type = null)
    {
        $this->curl_init();
